...
<asp:Content ID="Content3" ContentPlaceHolderID="ContenPlaceTitle" runat="server">ViewState</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div style="margin: 20px">
        <ul class="list-inline">
            <li></li>
            <li>Name:
                <asp:TextBox runat="server" ID="textProductId" />
                <asp:Button Text='Set to ViewState["ProductId"]' runat="server" ID="btnSetViewState" OnClick="btnSetViewState_Click" CssClass="btn-info" />
            </li>
            <li>
                <asp:Button Text='Get from ViewState["ProductId"]' runat="server" ID="btnGetViewState" OnClick="btnGetViewState_Click" CssClass="btn-info" />
            </li>
        </ul>
    </div>
</asp:Content>
