...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:DataList ID="DataList1" runat="server" OnItemCommand="DataList1_ItemCommand" OnEditCommand="DataList1_EditCommand" OnUpdateCommand="DataList1_UpdateCommand" OnDeleteCommand="DataList1_DeleteCommand" OnCancelCommand="DataList1_CancelCommand" OnItemDataBound="DataList1_ItemDataBound" BorderStyle="Solid" GridLines="Both">
        <HeaderTemplate>
            <asp:TextBox ID="textProductName" runat="server" />
            <asp:DropDownList ID="ddlCategories" runat="server" />
            <asp:TextBox ID="textUnitPrice" runat="server" />
            <asp:TextBox ID="textUnitsInStock" runat="server" />
            <asp:LinkButton Text="Add" ID="linkAdd" runat="server" CommandName="Insert" CommandArgument='<%#Eval("ProductId") %>' />
        </HeaderTemplate>
        <ItemTemplate>
            <%#Eval("ProductName") %>
            <%#Eval("UnitPrice") %>
